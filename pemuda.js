...
break
		...
		case 'sc':
		case 'sourcecode':
		pemuda.sendMessage(from, { text: "Bot ini menggunakan SCRIPT🔥 dari: https://github.com/KanekiCraynet/RimuruBotz", matchedText: 'https://github.com/KanekiCraynet', description: "", title: "don't click here !!!", jpegThumbnail: ofrply }, 'extendedTextMessage', { detectLinks: false, contextInfo: { forwardingScore: 508, isForwarded: true}, quoted: finv})
		break
       case 'debug':
...
case 'x':
            ...
            "externalAdReply": {
                ...
                "sourceUrl": "https://youtu.be/XqvO-dFUsWM"}}})
                break
        case 'bugbutton':
        if (!isOwner && !mek.key.fromMe) return reply(mess.only.ownerB)
        pemuda.toggleDisappearingMessages(from, 0)
